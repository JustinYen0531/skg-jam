...
/** Arcane speaks only while recovering the route; 184 itself remains silent. */
export const ARCANE_FLIGHT_REFLECTIONS: readonly ArcaneFlightReflection[] = [
  ...
  {
    score: 120,
    lines: ['I deleted everything that remembered them.', 'Just to reach this.'],
  },
  { score: 150, lines: ['No. Not everything.', 'I remember.'] },
  {
    score: 174,
    lines: ['You left me a route, Dad.', 'You still made me fly it.'],
  },
];
...
/** Sparse archival acknowledgements that travel with the autonomous flight. */
...
/** 256 holds, climbs visibly to the unsigned ceiling, then overflows at once. */
...
/**
 * Noah's last note fills the remaining Finale runtime after the 256 landing.
 * It closes known canon instead of introducing another puzzle.
 */
