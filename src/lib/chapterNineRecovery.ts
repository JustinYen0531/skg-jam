...
export const CHAPTER_NINE_CHILD_PROFILE: ChapterNineRecoveryProfile = {
  owner: 'ORIGINAL OPERATOR NAME MISSING',
  title: 'Legacy assistant authorization record',
  age: 'Created 12 years ago',
  detail: 'Authorization cannot restart until its original operator is identified',
  score: 184,
  packageSize: '18.0 GB',
  signature: 'ARC-184 · DEVICE VERIFIED',
};

export const CHAPTER_NINE_AUTHORIZATION_SOURCE = 'LUMEN ARC FAMILY BACKUP';
export const CHAPTER_NINE_OPERATOR_RESTORED = 'OPERATOR RESTORED · ARCANE KADE';
export const CHAPTER_NINE_LICENSE_MATCH = 'LICENSE MATCH · ARC-184';
