...
export const MetaWindowScene: React.FC<{ stage: MetaWallStage; reducedMotion: boolean }> = ({ stage, reducedMotion }) => {
  ...
  return (
    <div
      className="pointer-events-none absolute left-[68%] top-[14%] z-[1] h-[34%] w-[25%] overflow-hidden"
    ...
    >
      ...
      {stage >= 3 && (
        <svg className="absolute inset-0 h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none" id="meta-window-water-traces">
