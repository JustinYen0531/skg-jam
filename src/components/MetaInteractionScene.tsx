        ...
        {active && (
          <>
            <motion.img
              ...
              className="pointer-events-none absolute left-[-4.5%] top-0 z-[22] h-full w-full select-none object-fill drop-shadow-[0_16px_14px_rgba(0,0,0,0.28)]"
              style={{ clipPath: 'inset(0 50% 0 0)' }}
              data-hand-edge-offset="-4.5%"
              aria-hidden="true"
            ...
            <motion.img
              ...
              initial={false}
              transition={{ duration: reducedMotion ? 0 : 0.24, ease: 'easeOut' }}
              className="pointer-events-none absolute right-[-4.5%] top-0 z-[22] h-full w-full select-none object-fill drop-shadow-[0_16px_14px_rgba(0,0,0,0.28)]"
