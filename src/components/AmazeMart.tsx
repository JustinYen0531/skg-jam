              ...
              <div className="bg-slate-900/90 border border-emerald-500/30 rounded-lg p-4 text-center space-y-3 shadow-lg" id="am-delivery-success">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-300">
                    The package was immediately downloaded to your desktop space! We cannot run the 12-year-old console, but the previous owner left a whole folder of screenshots on it.
                  </p>
                </div>
                ...
                <div className="bg-slate-950 p-2.5 rounded border border-slate-800 text-left text-[10px] text-slate-400 space-y-1 font-mono">
                  ...
                  <div className="text-slate-500">📄 IMG_0001.png · IMG_0067.png · IMG_0088.png</div>
                  <div className="text-slate-500">📄 IMG_0091.png · IMG_0102.png · IMG_0110.png</div>
                  <div className="text-slate-500">📄 IMG_0142–0145.png <span className="text-slate-600">· 10 images, unsorted</span></div>
                </div>
